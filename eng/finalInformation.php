...
<body onload="jump()">
    ...
    <main>
        ...
        <section id="step5" class="py-5 px-5">
            <div class="modern-card position-relative mb-4 py-5 px-5">
                <h2>Step 5: Verifying Information in EasyChair</h2>
                <img src="../images/decoration/paperInfoCheck.jpg" alt="Checking uploaded information"
                    class="img-fluid float-start me-4 mb-3" style="max-width:100%; height:auto;">
                <p>Review and update the title, abstract, author names, and affiliations. Ensure accuracy, as this information will be used for author and paper indexing.</p>
                ...
                <p>If an author appears in multiple papers, make sure their name is listed consistently across all
                    ...
                    all their respective papers grouped under their name.</p>
            </div>
        </section>
        ...
        <section id="step8" class="py-5 px-5 bg-light">
            <div class="modern-card position-relative mb-4 py-5 px-5">
                ...
                <h2>Step 8: Upload the Final Paper as an IEEE Xplore®-Compliant PDF to EasyChair</h2>
                ...
                <p> This is a brief summary of all the recommendations from the previous steps to guide you in
                    submitting your final paper successfully. </p>
                <p> Please <b>upload the PDF generated by PDFeXpress</b> for a second review by a Technical Program
                    Committee member. Papers may require multiple reviews. To allow time for revisions, submit your final paper as
                    early as possible before the deadline. The last review will occur after the deadline (refer to the Timeline).
                    Failure to meet editorial requirements may result in rejection by IEEE Xplore®, delaying the
                    publication of proceedings and affecting all authors.</p>
                <p> To upload your final paper to EasyChair ensure your file is PDFeXpress-compatible with IEEE Xplore®. If you encounter 
                    errors, contact us at edunine@edunine.eu with the information to identify your paper in our SUBMISSION SYSTEM and the 
                    error details. Please DO NOT email the file, as we cannot upload or update submissions due to personal data protection laws. You
                    may upload revised versions as needed, but always regenerate the PDF using PDFeXpress after any changes.
                </p>
                <p>You can visit the conference EasyChair page at the following link: <a href="https://easychair.org/cfp/EDUNINE2026"> EDUNINE2026 EasyChair</a></p>
            </div>
        </section>
        ...
        <section id="step9" class="py-5 px-5">
            <div class="modern-card position-relative mb-4 py-5 px-5">
                ...
                <img src="../images/decoration/registration.jpg" alt="Conference Registration"
                    class="img-fluid float-start me-4 mb-3" style="max-width:100%; height:auto;">
                <p> Each accepted paper must be presented at the conference by one of its authors. <b>At least one author</b> of an
                    ...
                    please visit the <a href="fees.php">Fees and Registration<a> page on this website.</p>
        ...
        <section id="notifications" class="py-5 px-5 border">
            ...
            <p> Following each submission of your final paper, you'll receive a summary via email detailing the review
                ...
                quality standards for content, English, and format, as well as a proper PDF generation through PDFeXpress, and successful completion of
