...
<body onload="jump()">
    ...
    <main>
        ...
        <section id="step1" class="py-5 px-5">
            <h2>Step 1: Addressing the Reviewers' Recommendations and Revising Your Paper According to IEEE Standards
            </h2>
            <div class="row">
                ...
                <div class="col-md-9 col-12">
                    <p>Getting your final paper ready for submission is an important step to ensure it is
                        ...
                        suggestions, meet your paper's category requirements, and follow IEEE standards. Double-check
            ...
            <div class="py-3">
                ...
                <p>Authors must follow IEEE's ethical publishing
                    ...
                    ethics: <a href="https://conferences.ieeeauthorcenter.ieee.org/author-ethics/ethical-requirements/">
        ...
        <section id="step4" class="py-5 px-5 bg-light">
            ...
            <img src="../images/decoration/templates.jpg" alt="Adressing English writing"
                class="img-fluid float-start me-4 mb-3" style="max-width:100%; height:auto;">
            <p>Upon submission, all conference proceedings are automatically converted to HTML and other media by IEEE
                Xplore® software. Predefined formats and styles are markers for identifying text elements for
                convertion. Strict compliance with formats and styles is crucial. Non-compliance will prevent the paper
            ...
            <p>Please use the <b>MS-Word template conference-template-a4.docx</b> or the <b>LaTeX template
                    IEEE-conference-template-062824.pdf</b> as visual references for the required format and layout of
                your paper.</p>
            ...
            <ul>
                ...
                <li>Use predefined styles in the MS-Word template rather than manually adjusting document elements.</li>
            ...
            <ul>
                <li><b>Full papers:</b> Maximum 6 pages, including references, figures, tables, and a 150-word abstract.
                </li>
                <li><b>Work-in-progress (WIP) papers:</b> Maximum 4 pages, including references, figures, tables, and a
                    150-word abstract.</li>
                <li><b>Doctoral Symposium (DS) papers:</b> Maximum 4 pages, including references, figures, tables, and a
                    150-word abstract.</li>
        ...
        <section id="step5" class="py-5 px-5">
            ...
            <p>Review and update the title, abstract, author names, and affiliations in the EDUNINE2026 submission
                system. Ensure accuracy, as this information will be used for author and paper indexing. Any changes can
            ...
            <p>If an author appears in multiple papers, make sure their name is listed consistently across all
                submissions. In the Conference Proceedings Author Index, each author should appear only once, with all
            ...
            <ul>
                <li>Accurate Attribution: Inconsistent spelling can lead to fragmented citation records, reducing proper
                ...
                <li>Professional Recognition: Accurate name spelling ensures proper recognition of an author's body of
        ...
        <section id="step6" class="py-5 px-5 bg-light"">
            ...
            <img src=" ../images/decoration/IEEEPdfeXpress.jpg" alt="PDFexpress"
            class="img-fluid float-start me-4 mb-3" style="max-width:100%; height:auto;">
        ...
        <section id="step7" class="py-5 px-5">
            ...
            <div class="border w-100 bg-light rounded p-4 text-xenter shadow-sm">
                ...
                <p> Please note that access to complete and submit the <b>IEEE Copyright Form</b> will be available
                    after the <b>Peer-Review Notification date</b>. The conference has to await for the official access
                    link and updated guidelines from IEEE. We will share all necessary information with authors as soon
            ...
            <div class="pt-4">
                <p> After submission, IEEE will send you an e-mail with a copy copyrighttransfer agreement
                    ...
                    you and your co-authors. For more information on this process, please refer to the <a
                        href="https://www.ieee.org/publications_standards/publications/rights/copyrightmain.html"> IEEE
                        Electronic Copyright Form information page</a>.</i></p>
                <p> Please DO NOT send that copy to EDUNINE by email; it is intended for the authors' records only.</p>
            </div>
        </section>
        ...
        <section id="step8" class="py-5 px-5 bg-light">
            ...
            <img src="../images/decoration/submissionFinalPapers.jpg" alt="Final Papers submission"
                class="img-fluid float-start me-4 mb-3" style="max-width:100%; height:auto;">
            <p> This is a brief summary of all the recommendations from the previous steps to guide you in submitting
            ...
            <p> Please <b>upload the PDF generated by PDFeXpress</b> for a second review by a Technical Program
                Committee member. Papers with conditional acceptance (major/minor revisions or reformatted as Work in
                Progress) may require multiple reviews. To allow time for revisions, submit your final paper as early as
                possible before the deadline. The last review will occur after the deadline (refer to the Timeline).
                Failure to meet editorial requirements may result in rejection by IEEE Xplore®, delaying the publication
            ...
            <p> To upload your final paper to the EDUNINE2026 SUBMISSION SYSTEM Ensure your file is
                PDFeXpress-compatible with IEEE Xplore®. If you encounter errors, contact us at edunine@edunine.eu with
                the information to identify your paper in our SUBMISSION SYSTEM and the error details. Please DO NOT
                email the file, as we cannot upload or update submissions due to personal data protection laws. You may
                upload revised versions as needed, but always regenerate the PDF using PDFeXpress after any changes.</p>
        ...
        <section id="step9" class="py-5 px-5">
            ...
            <p> <b>IEEE Non-Presented Paper Policy ("No-Show Policy")</b>: Papers not presented by their authors during
