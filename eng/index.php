...
<html lang="en">
    ...
    <body onload = "obtenerFechas(), jump()">
        ...
        <!--custom-breadcrumb because that is how it's named in EDU9Conferences-->
                ...
                <!-- PARTE SUSAN FIN -->
                <div class="container align-content-start py-0 px-1">   <!--fw-bold is not working as well.-->
                    <div class="row">
                        <div class="col-sm-12 text-sm-left">
                            ...
                            <button class=" btn btn-primary btn-lg border-4" onclick="changeReadMore()" id="myBtn">Read more</button>
                        </div>
                    </div>
                </div>
            </section>
