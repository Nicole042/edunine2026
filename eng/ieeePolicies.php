                    ...
                    <div class= "col text-sm-left">
                        <div class="clearfix">
                                ...
                                <ol class="conduct-rules">
                                    ...
                                    <li class="conduct-rule">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="rule-title">Avoid injuring others, their property, reputation or employment</span>
                                        </div>
                                        <div class="rule-content">
                                            <div class="rule-item">
                                    ...
                                    <li class="conduct-rule">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="rule-title">Comply with applicable laws and IEEE policies</span>
                                        </div>
                                        <div class="rule-content">
                                            <div class="rule-item">
                                            ...
                                            <div class="sub-items">
                                                ...
                                                <div class="sub-item">b) Avoiding real or perceived conflicts of interest whenever possible, and disclosing them to affected parties when they do exist.</div>
                                                <div class="sub-item">c) Protecting confidential information belonging to IEEE and personal information belonging to IEEE members, employees and other persons.</div>
                                                <div class="sub-item">d) Not agreeing with competing persons to fix prices or reduce price competition through allocation of customers or markets, manipulate bids in any competitive bidding process, or engage in other acts that result in restraining trade.</div>
                                                <div class="sub-item">e) Not misusing or infringing the intellectual property of others.</div>
                                            </div>
                                        </div>
                                    </li>
                                </ol>
                            ...
                            <div class="ieee-download-container d-flex flex-column align-items-center text-center">
                                ...
                                <a href="https://www.ieee.org/content/dam/ieee-org/ieee/web/org/about/ieee_code_of_conduct.pdf" class="download-btn">IEEE Code of Conduct (PDF)</a>
                            </div>
                        </div>
                    </div>
                </div>
