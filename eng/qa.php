            ...
            <div class="accordion" id="accordionExample">
                ...
                <div class="accordion-item">
                    ...
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                        <span class="fs-4 fs-md-2 fs-sm-4 fw-normal">When is the deadline for paper submission?</span>
                    </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                            <span class="fs-4 fs-md-2 fs-sm-4">Until what time (and time zone) will the submission system remain open on the deadline date?</span>
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            <span class="fs-4 fs-md-2 fs-sm-4">Do I need to pay the registration fee before or after my paper is accepted?</span>
                        </button>
                    </h2>
                    <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <ul>
                                <b>After acceptance.</b> Author registration opens post-notification and is mandatory for publication/presentation.
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                            <span class="fs-4 fs-md-2 fs-sm-4">What happens after my paper is accepted? Are there additional steps?</span>
                        </button>
                    </h2>
                    <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <ul>
                                Yes: apply reviewers’ recommendations, pass originality checks, ensure IEEE template/English compliance, create a PDF eXpress-validated PDF, sign the IEEE copyright, upload the final paper, and register at least one author.
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <ul>
                                Please submit your workshop proposal in the IEEE format on the platform. The proposal will be reviewed by peers, as in the other categories.
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                        <span class="fs-4 fs-md-2 fs-sm-4">Is the conference hybrid? Can accepted authors present virtually?</span>
                    </button>
                    </h2>
                    <div id="collapseSix" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <ul>
                                <b>Yes.</b> EDUNINE 2026 is hybrid; presentations may be in-person or online and are valued equally.
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                            <span class="fs-4 fs-md-2 fs-sm-4">What platform will be used for virtual participation (Zoom/Teams/Meet)?</span>
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    ...
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
                        <span class="fs-4 fs-md-2 fs-sm-4">When and how should I complete the payment for the registration?</span>
                    </button>
                    </h2>
                    <div id="collapseNine" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <ul>
                                During Early/Normal/Late windows after acceptance, pay by credit card via PayPal (EUR) or bank transfer (EUR or USD).
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseTen" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <ul>
                                Contact the organizers by email. PayPal/bank transfers provide receipts; official invoices are issued upon request.
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseEleven" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <ul>
                                <b>Yes</b> — registration/payment happens after acceptance and is required for publication/presentation.
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwelve" aria-expanded="false" aria-controls="collapseTwelve">
                            <span class="fs-4 fs-md-2 fs-sm-4">Do I need to pay any extra fee to publish my paper in the proceedings?</span>
                        </button>
                    </h2>
                    <div id="collapseTwelve" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <ul>
                                One paid author registration covers one paper; an additional second paper requires an extra <b>“Paper Fee.”</b> For a third paper, authors must pay a new registration fee.
                            </ul>
                        </div>
                    </div>
                </div>
